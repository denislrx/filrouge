...
?>
    ...
    <body>
        <?php
        viewBodyAgenda($objEvent, $profil);
        ?>
    </body>
...
?>
    <div class="container-fluid">
      <div class="row header1">
          <div class="col-md-10"><h1>Toute l'actualité culturelle de Roubaix</h1></div>
            ...
            <nav class="navbar navbar-expand-lg bg-light menu">
              <div class="container-fluid BarreNav">
                <div class="banniere">
                  ...
                  <div class="col-md-8"><h3>Toute l'actualité culturelle de Roubaix</h3></div>
                </div>  
